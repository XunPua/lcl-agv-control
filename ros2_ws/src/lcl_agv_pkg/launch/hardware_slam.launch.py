...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(get_package_share_directory(package_name), 'config', 'hardware_deployment.rviz')
    
    # define SLAM configuration file
    slam_params_file_path = os.path.join(get_package_share_directory(package_name), 'config', 'mapper_params_online_async.yaml')
